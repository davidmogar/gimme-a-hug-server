...
server.get('/users/auth/:email', userRoutes.validate);
server.post('/users/:id/location', userRoutes.updateLocation);
server.post('/users/:id/image', userRoutes.uploadProfileImage);
server.get('/users/:id/image', userRoutes.getProfileImage);
server.get('/users/:id/starred', userRoutes.getStarred);
server.post('/users/:id_user_1/notify/:id_user_2', userRoutes.addHugNotification);
server.get('/users/:id/hugs/notifications', userRoutes.consumeHugNotifications);
server.post('/users/:id_user_1/accept/:id_user_2', userRoutes.acceptHug);
server.get('/users/:id/hugs/accepted', userRoutes.consumeAcceptedHugs);
