...
server.put('/user/:username', controllers.user.updateUser);
server.del('/user/:username', controllers.user.deleteUser);
server.get('/user/:username', controllers.user.viewUser);
